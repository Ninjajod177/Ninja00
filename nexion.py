...
from nexionn import TOKEN   # Import the TOKEN and ADMIN_ID variables
...
EXPIRY_DATE = datetime(2025, 11, 28)  # Set expiry date to 1st November 2024
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if check_expiry():
        ...
        keyboard2 = [[InlineKeyboardButton("JOIN CHANNEL", url="https://t.me/NEXION_OWNER")]]
